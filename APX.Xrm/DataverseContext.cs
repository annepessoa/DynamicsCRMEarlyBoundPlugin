...
namespace APX.Xrm
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="APX.Xrm.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<APX.Xrm.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<APX.Xrm.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="APX.Xrm.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<APX.Xrm.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<APX.Xrm.Contact>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="APX.Xrm.APX_Location"/> entities.
		/// </summary>
		public System.Linq.IQueryable<APX.Xrm.APX_Location> apx_LocationSet
		{
			get
			{
				return this.CreateQuery<APX.Xrm.APX_Location>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="APX.Xrm.apx_Trips"/> entities.
		/// </summary>
		public System.Linq.IQueryable<APX.Xrm.apx_Trips> apx_TripsSet
		{
			get
			{
				return this.CreateQuery<APX.Xrm.apx_Trips>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="APX.Xrm.Incident"/> entities.
		/// </summary>
		public System.Linq.IQueryable<APX.Xrm.Incident> IncidentSet
		{
			get
			{
				return this.CreateQuery<APX.Xrm.Incident>();
			}
		}
	}
